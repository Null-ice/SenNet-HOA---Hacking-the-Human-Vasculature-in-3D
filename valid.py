...
def valid(m):
    seed_everything(42)
    valid_x, valid_y, valid_z = get_loader('valid', '/content/drive/MyDrive/ColabNotebooks/SenNet_Comp/train', 4, 4)
    
    depth = 501
    height = 1706
    width = 1510
    
    model = ConvNeXt_U().cuda()
    ...
    df = pd.read_csv('/content/drive/MyDrive/ColabNotebooks/SenNet_Comp/train/gt.csv')
